package com.salamych.cinema.api.models;
...
public final class ScheduleModel extends CommonModel {
    ...
    // конструктор # 1 - используется для создания экземпляра и входящего запроса
    @JsonCreator
    ...
    public ScheduleModel(final String[] fields) throws IllegalArgumentException {
        ...
        if (fields != null && fields.length == 5) {
            try {
                ...
                this.dateAndTime = fields[2];                       // дата и время начала
