package com.salamych.cinema.api.storages;

import com.salamych.cinema.api.models.CommonModel;
...
public abstract class CommonStorage<T extends CommonModel> {
    ...
    // найти запись по заданному индетификатору
    ...
    // удалить поле с заданным индетификатором
